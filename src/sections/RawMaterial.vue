...
<template>
  <div class="page-wrapper">
    <div class="content">
      ...
      <!-- form -->
      <div class="card" v-if="cPage == 'raw-material' && loaded">
        <div class="card-body">
          <div class="row">
      ...
      <div
        class="card"
        v-if="cPage == 'raw-material-list' && loaded"
        :key="cPage + '-raw-material-list'"
      >
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped mb-0">
              ...
              <tbody>
                <tr
                  v-for="item in store.filterItemType('Raw Material')"
                  :key="item.id"
                >
                  <td>{{ item.name }}</td>
                  <td>{{ item.type }}</td>
                  ...
                  <td>
                    <a
                      class="me-3"
                      href=""
                      @click.prevent="store.editRecord('raw-material', item)"
                    >
