...
const tableCols = ref([
  ...
  { field: "acc_no", title: "Acc No." },
  // { field: "address", title: "Address" },
  { field: "actions", title: "Actions", search: false },
]);

const supplierRecModalRef = ref(null);

const showLocaRecModal = (t = true) => {
  supplierRecModalRef.value.toggleLocalRecModal(t);
};

const sectionName = "supplier";
    ...
    <div class="content">
      <div class="page-header">
        <div class="page-title">
          <h4>supplier Add</h4>
          <h6
            >Add/update supplier(s) for <strong>{{ cCompany.name }}</strong></h6
          >
        </div>
      ...
      <div class="card" v-if="cPage == sectionName && loaded">
        <div class="card-body">
          <div class="row">
            ...
            <InputField v-model="formData.acc_no" label="Acc No." col="4" />
